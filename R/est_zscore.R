#'Estimates the absolute Z Score for a single SNP, assuming the input CVs, and the relationship, gamma, between them and the trait of interest
...
#'@return The estimated Z Score for SNP X, assuming the causal SNPs are W
#'@author Mary Fortune
